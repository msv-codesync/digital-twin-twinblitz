...
export const QUIZ_OFFICIAL = [
  {
    ...
    keyPhrase: "Always include 'throughout its lifecycle' — the twin spans design through service.",
  },
  {
    n: 2,
    ...
    keyPhrase: "Product lifecycle = Design, Manufacture, Build, Test, Service — separate from software dev cycle.",
  },
  {
    n: 3,
    ...
    keyPhrase: "Parameters drive geometry and simulation together — enables DoE on one master model.",
  },
  {
    n: 4,
    ...
    keyPhrase: "Accuracy = closeness to reality. Fidelity = level of detail.",
  },
  {
    n: 5,
    ...
    keyPhrase: "Coupling = interdependent physics in an iterative loop.",
  },
  {
    n: 6,
    ...
    keyPhrase: "Empirical = built from data and statistics; physics-based = first principles.",
  },
  {
    n: 7,
    ...
    keyPhrase: "Calibration tunes parameters; validation checks against independent reality.",
  },
  {
    n: 8,
    ...
    keyPhrase: "Verification = maths right. Validation = right maths.",
  },
  {
    n: 9,
    ...
    keyPhrase: "Idealisation simplifies geometry while keeping key physics — linked to master CAD.",
  },
  {
    n: 10,
    ...
    keyPhrase: "Curve fitting builds an empirical model; validate on new data separately.",
  },
  {
    n: 11,
    ...
    keyPhrase: "Minimise Σ(yᵢ − f(xᵢ))² — best-fit line through noisy data.",
  },
  {
    n: 12,
    ...
    keyPhrase: "Stay inside DoE bounds when recommending operating limits.",
  },
];
